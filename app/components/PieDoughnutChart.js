...
render() {
    ...
    if(this.props.cryptoCoin.length <= 5) {
        let sortedCryptoCoin = this.props.cryptoCoin.sort((a, b) => b.primaryCurrencyAmount - a.primaryCurrencyAmount)
    ...
    return(
      <Card title={this.props.title}>
        {this.props.type === 'Pie' ? <Pie data={data} options={options} height={300} /> : <Doughnut data={data} options={options} height={300} />}
      </Card>
    )
  }
}

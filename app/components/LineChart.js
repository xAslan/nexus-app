...
class LineChart extends React.Component {
    ...
    for(let i = 0; i < this.props.valueOfAccount.length; i++) {
      ...
      if(this.state.chartRange === 'All') {
          chartLabelInProgress.push(d.getDate() + ' ' + d.toLocaleString('default', {month: 'short'}) + ' ' + d.getFullYear());
      ...
      } else if (this.state.chartRange === 'lastWeek' && this.props.valueOfAccount[i].timestamp >= lastWeekStart.getTime() && this.props.valueOfAccount[i].timestamp < lastWeekEnd.getTime()) {
          chartLabelInProgress.push(d.getDate() + ' ' + d.toLocaleString('default', {month: 'short'}) + ' ' + d.getFullYear());
          chartDataInProgress.push(this.props.valueOfAccount[i].value);

          this.chartLabelName = chartLabelInProgress;
          this.chartData = chartDataInProgress;
      } else if (this.state.chartRange === 'lastMonth' && this.props.valueOfAccount[i].timestamp >= lastMonthStart.getTime() && this.props.valueOfAccount[i].timestamp < lastMonthEnd.getTime()) {
          chartLabelInProgress.push(d.getDate() + ' ' + d.toLocaleString('default', {month: 'short'}) + ' ' + d.getFullYear());
          chartDataInProgress.push(this.props.valueOfAccount[i].value);

          this.chartLabelName = chartLabelInProgress;
          this.chartData = chartDataInProgress;
      } else if (this.state.chartRange === 'threeMonth' && this.props.valueOfAccount[i].timestamp >= threeMonthStart.getTime() && this.props.valueOfAccount[i].timestamp < threeMonthEnd.getTime()) {
          chartLabelInProgress.push(d.getDate() + ' ' + d.toLocaleString('default', {month: 'short'}) + ' ' + d.getFullYear());
          chartDataInProgress.push(this.props.valueOfAccount[i].value);

          this.chartLabelName = chartLabelInProgress;
          this.chartData = chartDataInProgress;
      } else if (this.state.chartRange === 'sixMonth' && this.props.valueOfAccount[i].timestamp >= sixMonthStart.getTime() && this.props.valueOfAccount[i].timestamp < sixMonthEnd.getTime()) {
          chartLabelInProgress.push(d.getDate() + ' ' + d.toLocaleString('default', {month: 'short'}) + ' ' + d.getFullYear());
          chartDataInProgress.push(this.props.valueOfAccount[i].value);

          this.chartLabelName = chartLabelInProgress;
          this.chartData = chartDataInProgress;
      } else if (this.state.chartRange === 'lastYear' && this.props.valueOfAccount[i].timestamp >= lastYearStart.getTime() && this.props.valueOfAccount[i].timestamp < lastYearEnd.getTime()) {
          chartLabelInProgress.push(d.getDate() + ' ' +d.toLocaleString('default', {month: 'short'}) + ' ' + d.getFullYear());
          chartDataInProgress.push(this.props.valueOfAccount[i].value);
